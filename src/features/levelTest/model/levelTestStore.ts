...
export const LEVEL_TEST_QUESTIONS: Question[] = [
  {
    ...
    options: [
      ...
      { id: "q1_4", text: "닭갈비, 찜닭, 고기구이, 감자탕/전골, 족발/보쌈, 샤브샤브" },
    ],
  },
  {
    id: "q2",
  ...
  },
  {
    ...
    options: [
      { id: "q3_1", text: "전혀 못 해요" },
      { id: "q3_2", text: "가끔 먹지만 부담돼요" },
      { id: "q3_3", text: "상황에 따라 시도할 수 있어요" },
      { id: "q3_4", text: "네, 혼자서도 문제없어요" },
    ],
  },
  {
    id: "q4",
    type: "single",
    question: "혼밥할 때 어떤 점이 가장 중요하신가요?",
    options: [
      { id: "q4_1", text: "빠르고 간편하게 먹을 수 있어야 해요" },
      { id: "q4_2", text: "1인 메뉴가 있어야 해요" },
      { id: "q4_3", text: "다양한 메뉴를 즐길 수 있어야 해요" },
      { id: "q4_4", text: "원하는 음식이면 조건은 상관없어요" },
    ],
  },
  {
    id: "q5",
