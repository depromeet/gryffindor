...
export function MapRefreshButton({ onClick }: MapRefreshButtonProps) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="-translate-x-1/2 fixed top-[85px] left-1/2 z-49 flex h-9 w-[139px] cursor-pointer flex-row items-center gap-1 rounded-[20px] bg-gray0 py-1.5 pr-3 pl-2 shadow-[0_4px_12px_0_rgba(0,0,0,0.15)]"
    >
